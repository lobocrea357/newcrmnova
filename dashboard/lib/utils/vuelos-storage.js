...
export function getStoragePath(vuelo_id, tipo_adjunto, filename) {
...
export async function deleteAdjunto(supabase, path) {
...
export async function getAdjuntoUrl(supabase, path) {
