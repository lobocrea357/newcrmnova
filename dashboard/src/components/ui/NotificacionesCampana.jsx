...
import { Bell, X, CheckCheck, Trash2, Plane, Info, AlertCircle, AlertTriangle, CheckCircle } from 'lucide-react'
...
function iconoTipo(tipo) {
  ...
  if (tipo === 'pago_confirmado') return <CheckCircle className="w-4 h-4 text-green-600" />
