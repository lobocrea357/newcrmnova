-- ============================================
-- CORRECCIÓN: Chats y Vistas Mejoradas
-- ============================================
-- Ejecutar en Supabase SQL Editor
-- ============================================

-- ============================================
-- 1. ACTUALIZAR VISTA DE CONVERSACIONES RECIENTES
-- ============================================
-- Esta vista ahora muestra el número de teléfono cuando no hay nombre
...
-- ============================================
-- 2. CREAR VISTA DE MENSAJES DETALLADOS
-- ============================================
-- Incluye información completa de mensajes con multimedia
...
-- ============================================
-- 3. CREAR VISTA DE ESTADÍSTICAS POR BOT
-- ============================================
...
-- ============================================
-- 4. CREAR VISTA DE CONTACTOS DETALLADOS
-- ============================================
...
-- ============================================
-- 6. ACTUALIZAR POLÍTICAS RLS PARA VISTAS
-- ============================================

-- Permitir que usuarios autenticados vean las vistas
ALTER VIEW recent_conversations SET (security_invoker = on);
ALTER VIEW messages_detailed SET (security_invoker = on);
ALTER VIEW bot_statistics SET (security_invoker = on);
ALTER VIEW contacts_detailed SET (security_invoker = on);
...
SELECT '✅ VISTAS Y CORRECCIONES APLICADAS EXITOSAMENTE' as status;
SELECT 'Los chats ahora muestran el número cuando no hay nombre' as info;
SELECT 'Las vistas incluyen información completa de multimedia' as info2;
